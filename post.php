...
<div class="container-fluid">
    <div class="row">
                        ...
                        if(mysqli_num_rows($res)>0)
                        {
                            ...
                            ?>
                                ...
                                <div class="card-panel">
                                    <div class="collection  teal center with-header">
                                    <h5 class="teal white-text"><?php echo ucwords($title);?></h5>
                                    </div>
                                    <h5 class="yellow"><b>Author</b> : <?php echo $row["username"]?> <br/><b>Date</b> : <?php echo $row["post_date"];?></h5>
        ...
        <div class="col l12 m12 s12" style="margin-top:10em">
            <div class="collection teal center with-header">
                    <h5 class="teal white-text">Related Blogs</h5>
            </div>
